...
TEST(Matrix2D_Initialization, InitializedWithThree3DVectorsProvidesCorrectMatrix)
{
	// Arrange & Act
	const math::Vector2D col1(0.0f, 3.0f, 6.0f);
	const math::Vector2D col2(1.0f, 4.0f, 7.0f);
	const math::Vector2D col3(2.0f, 5.0f, 8.0f);

	const math::Matrix2D mat(col1, col2, col3);
...
TEST(Matrix2D_Initialization, CanMutateVectorAtIndex)
{
	...
	math::Vector2D vec(3.0f, 1.0f, 6.0f);
